#include "llama.h"
#include "../../src/llama-kv-offloading.h"  // ADDED: KV cache SSD offloading
#include "ggml-backend.h"                   // ADDED: GGML Backend Scheduler API
#include <cstdio>
#include <cstring>
#include <string>
#include <vector>
...
int main(int argc, char ** argv) {
    ...
    printf("[KV-SSD] ✓ KV offloader initialized\n");
    ...
    // CRITICAL: Set GGML Backend Scheduler Callback in context params
    ctx_params.cb_eval = llama_kv_ggml_eval_callback;
    ctx_params.cb_eval_user_data = &cb_data;
    printf("[KV-SSD] ✓ GGML Backend Scheduler callback configured\n");
    // =============================================================================
    ...
    printf("[KV-SSD] ✓ Real layer-wise callback system activated\n");
    // =============================================================================
    ...
    printf("[KV-SSD] ✓ All saves completed\n");
    
    uint32_t final_pending = llama_kv_offloader_pending_saves(kv_offloader);
    printf("[KV-SSD] Final pending saves: %u\n", final_pending);
