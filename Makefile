...
CMAKE_SOURCE_DIR = /home/chokwans99/llama.cpp_test

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /home/chokwans99/llama.cpp_test
...
all: cmake_check_build_system
	$(CMAKE_COMMAND) -E cmake_progress_start /home/chokwans99/llama.cpp_test/CMakeFiles /home/chokwans99/llama.cpp_test//CMakeFiles/progress.marks
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 all
	$(CMAKE_COMMAND) -E cmake_progress_start /home/chokwans99/llama.cpp_test/CMakeFiles 0
.PHONY : all
...
#=============================================================================
# Target rules for targets named test-ggml-callback

# Build rule for target.
test-ggml-callback: cmake_check_build_system
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 test-ggml-callback
.PHONY : test-ggml-callback

# fast build rule for target.
test-ggml-callback/fast:
	$(MAKE) $(MAKESILENT) -f src/CMakeFiles/test-ggml-callback.dir/build.make src/CMakeFiles/test-ggml-callback.dir/build
.PHONY : test-ggml-callback/fast
...
#=============================================================================
# Target rules for targets named llama-speculative-eagle

# Build rule for target.
llama-speculative-eagle: cmake_check_build_system
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 llama-speculative-eagle
.PHONY : llama-speculative-eagle

# fast build rule for target.
llama-speculative-eagle/fast:
	$(MAKE) $(MAKESILENT) -f examples/speculative-eagle/CMakeFiles/llama-speculative-eagle.dir/build.make examples/speculative-eagle/CMakeFiles/llama-speculative-eagle.dir/build
.PHONY : llama-speculative-eagle/fast
...
#=============================================================================
# Target rules for targets named llama-speculative-simple-eagle

# Build rule for target.
llama-speculative-simple-eagle: cmake_check_build_system
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 llama-speculative-simple-eagle
.PHONY : llama-speculative-simple-eagle

# fast build rule for target.
llama-speculative-simple-eagle/fast:
	$(MAKE) $(MAKESILENT) -f examples/speculative-simple-eagle/CMakeFiles/llama-speculative-simple-eagle.dir/build.make examples/speculative-simple-eagle/CMakeFiles/llama-speculative-simple-eagle.dir/build
.PHONY : llama-speculative-simple-eagle/fast
...
#=============================================================================
# Target rules for targets named llama-kv-cache-offloading

# Build rule for target.
llama-kv-cache-offloading: cmake_check_build_system
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 llama-kv-cache-offloading
.PHONY : llama-kv-cache-offloading

# fast build rule for target.
llama-kv-cache-offloading/fast:
	$(MAKE) $(MAKESILENT) -f examples/kv-cache-offloading/CMakeFiles/llama-kv-cache-offloading.dir/build.make examples/kv-cache-offloading/CMakeFiles/llama-kv-cache-offloading.dir/build
.PHONY : llama-kv-cache-offloading/fast
...
help:
	...
	@echo "... llama-gritlm"
	@echo "... llama-imatrix"
	@echo "... llama-kv-cache-offloading"
	...
	@echo "... llama-speculative-eagle"
	@echo "... llama-speculative-simple"
	@echo "... llama-speculative-simple-eagle"
	@echo "... llama-tokenize"
	@echo "... llama-tts"
	@echo "... llama-vdot"
	@echo "... mtmd"
